...
eval_pred = []
# eval_pred.append(decode(xgb_model.predict(X_eval)))
eval_pred.append(decode(lgb_model.predict(X_eval)))
eval_pred.append(np.load('tabpfn_rf_eval_pred.npy', allow_pickle=True))
for i, this_pred in enumerate(eval_pred):
    print("pred i->")
